package com.asgamer
{
	...
	public class EnemyBig extends MovieClip
	{
...
//Remove enemy from the stage and from balls.array
		private function removeSelf():void
		{
			if(Engine.round.contains(this))
			{
				...
				Engine.round.addChild(new KillScore(stageRef, x, y, 100, 100));
				Engine.score.updateFood(100);
				Engine.score.updateGold(100);
				Engine.score.updateScore(120);
